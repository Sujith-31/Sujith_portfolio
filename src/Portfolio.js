...
export default function Portfolio() {
    ...
    const workExperience = [
        {
            ...
            responsibilities: [
                "Designed and executed manual and automated test cases for web, mobile, and desktop applications with comprehensive functional coverage",
                "Performed functional, regression, smoke, sanity, and integration testing across multiple product modules ensuring quality releases",
                "Validated backend processes and workflows using SQL queries and executed precise test scenarios for data integrity verification",
                "Automated desktop application workflows using Python Selenium, Appium, and WinAppDriver improving testing efficiency by 40%",
                "Conducted AI/ML validation tests for model behavior, inference accuracy, and end-to-end data flow in Custom Vision implementations",
                "Developed internal testing tools using Flask and React to streamline test execution and reporting workflows"
            ]
        },
        {
            ...
            responsibilities: [
                "Executed 500+ manual and automation test cases for large-scale web and mobile applications achieving 95% functional coverage",
                "Performed regression, sanity, smoke, and functional testing identifying and logging 200+ defects using Jira with detailed reproduction steps",
                "Validated backend data using complex SQL queries across web, mobile, and database environments ensuring data consistency",
                "Developed reusable and modular test cases reducing testing time by 30% and improving overall testing efficiency and coverage",
                "Collaborated with development and product teams in Agile/Scrum environment for root cause analysis and rapid issue resolution",
                "Supported backend validation including sales transactions, tax/discount schemes, pricing calculations, and inventory flow testing"
            ]
        }
    ];
    ...
    const skillCategories = [
        {
            ...
            skills: ["Python Selenium", "Appium & WinAppDriver", "Manual Testing", "Test Case Design", "Regression & Smoke Testing", "API Testing with Postman"]
        },
        {
            title: "Testing Tools & Platforms",
            skills: ["Jira (Defect Tracking)", "SQL (Database Validation)", "TestNG & Pytest", "Jenkins (CI/CD)", "Agile/Scrum Methodology", "Cross-Browser Testing"]
        },
        {
            title: "AI/ML",
            skills: ["Custom Vision Model Validation", "Inference Accuracy Testing", "Git Version Control"]
        }
    ];
    ...
    return (
        <div className={`${darkMode ? "bg-gray-900 text-white" : "bg-gray-50 text-gray-900"} min-h-screen transition-all duration-500`}>
            ...
            {/* Contact Section */}
            <section id="contact" className={`py-20 px-6 border-t ${darkMode ? "border-neutral-800" : "border-neutral-200"}`}>
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl font-bold mb-8">Reach Out</h2>

                    <div className={`w-24 h-24 rounded-full mx-auto mb-6 flex items-center justify-center border-2 ${darkMode ? "border-neutral-700 bg-neutral-900" : "border-neutral-300 bg-neutral-100"}`}>
                        <img 
                            src="/Contact.png" 
                            alt="Contact" 
                            className={`w-16 h-16 object-contain ${darkMode ? "invert" : ""}`}
                        />
                    </div>

                    <h3 className="text-2xl font-bold mb-2">Sujith Balaji A</h3>
                    <a href="mailto:sujithbalajia@gmail.com" className={`text-lg mb-8 block ${darkMode ? "text-neutral-400 hover:text-neutral-300" : "text-neutral-600 hover:text-neutral-700"}`}>
                        sujithbalajia@gmail.com
                    </a>

                    <div className="flex justify-center gap-4 mb-12">
                        <a href="mailto:sujithbalajia@gmail.com" className={`p-3 rounded-lg transition ${darkMode ? "hover:bg-neutral-800" : "hover:bg-neutral-100"}`}>
                            <Mail size={24} />
                        </a>
                        <a href="https://www.linkedin.com/in/sujith-balaji/" target="_blank" rel="noopener noreferrer" className={`p-3 rounded-lg transition ${darkMode ? "hover:bg-neutral-800" : "hover:bg-neutral-100"}`}>
                            <Linkedin size={24} />
                        </a>
                        <a href="tel:+919677996675" className={`p-3 rounded-lg transition ${darkMode ? "hover:bg-neutral-800" : "hover:bg-neutral-100"}`}>
                            <Phone size={24} />
                        </a>
                    </div>

                    <p className={`text-sm ${darkMode ? "text-neutral-600" : "text-neutral-400"}`}>
                        © {new Date().getFullYear()} Sujith Balaji A • Built with React & Tailwind
                    </p>
                </div>
            </section>
        </div>
